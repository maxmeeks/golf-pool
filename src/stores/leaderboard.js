...
export const useLeaderboardStore = defineStore("leaderboard", {
	...
	actions: {
		...
		updatePinnedTeam(index, name) {
			...
			this.createdTeams[index].isPinned =
				!this.createdTeams[index].isPinned;
			this.resetPinned(index);

			if (
				this.createdTeams[0].teamName !==
				this.createdTeams[index].teamName
			) {
				this.createdTeams.unshift(
					this.createdTeams.splice(index, 1)[0]
				);
			}
		},
