<template>
	<div
		class="w-full px-3 py-2 bg-white border-l border-slate-300 flex space-x-3"
		:class="[
			{
				'border-b border-slate-300':
					index !== 9 && index !== 3 && index !== cutIndex,
			},
			{ 'opacity-50': index > 3 },
		]"
	>
		...
		<div class="flex-1 flex flex-col">
			...
			<div class="flex space-x-3 items-center">
				...
				>
					...
					<template
						v-else-if="
							model.linescores[model.status?.period - 1]
								?.displayValue
						"
					>
						{{
